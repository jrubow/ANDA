...
function GuestPage() {
    ...
    return (
        <div className="homepage-container">
            ...
            <div className="sidebar">
                ...
                <nav>
                    <ul>
                        ...
                        {/* Move this li element 150px down */}
            ...
            <div className="map-container" style={mapContainerStyle}>
                ...
                >
                    ...
                    >
                        ...
                        {/* Heatmap layers are managed manually via useEffect */}
                    </GoogleMap>
                </LoadScript>
            </div>
            ...
            {/* Sidebar */}
            <div className="sidebar">
                <div className="alert-box" style={{ marginTop: "100px" }}>
                    <h2>West Lafayette</h2>
                    <p>2 Alerts</p>
                </div>
                <nav style={{ marginTop: "150px" }}>
                    <ul>
                        ...
                        <li>
                            <button className="sidebar-btn" onClick={() => alert("Please Register or Login to access personal information!")}>
                                Personal Information
                            </button>
                        </li>
                        <li>
                            <button className="sidebar-btn" onClick={() => alert("Please Login or Register to change preferences!")}>
                                Preferences
                            </button>
                        </li>
